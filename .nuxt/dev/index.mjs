...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://G:/mqtt/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://G:/mqtt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://G:/mqtt/node_modules/devalue/index.js';
import destr from 'file://G:/mqtt/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://G:/mqtt/node_modules/ufo/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://G:/mqtt/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://G:/mqtt/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://G:/mqtt/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://G:/mqtt/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://G:/mqtt/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://G:/mqtt/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://G:/mqtt/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://G:/mqtt/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://G:/mqtt/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://G:/mqtt/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://G:/mqtt/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://G:/mqtt/node_modules/vue/index.mjs';
import { hash } from 'file://G:/mqtt/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://G:/mqtt/node_modules/unstorage/dist/index.mjs';
import fsDriver from 'file://G:/mqtt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://G:/mqtt/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://G:/mqtt/node_modules/@unhead/shared/dist/index.mjs';
...
const _36DfQeWng8 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "G:/mqtt";
...
const _lazy_hSOG6u = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_hSOG6u, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hSOG6u, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"G:/mqtt/server/assets"}];
...
const getClientManifest = () => import('file://G:/mqtt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
